...
namespace Graphs.Data
{
    ...
    public class SGraphMatrixInc
    {
        public SGraphMatrixInc(int nodes, int cons)
        {
            nodesNr = nodes;
            connectNr = cons;
            connect = new int[nodesNr, connectNr];
        }
        public SGraphMatrixInc(int nodes, int cons, int[,] arr)
        {
            nodesNr = nodes;
            connectNr = cons;
            connect = new int[nodesNr, connectNr];
        ...
        */
        ...
        public bool Equals(SGraphMatrixInc x)
        {
            if (x == null)
                return false;
            if ((this.NodesNr != x.NodesNr) || (this.ConnectNr != x.ConnectNr))
